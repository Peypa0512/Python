...
cabecera = sopa.find("table", class_="sortable wikitable").find('tbody').find_all('th')

titulos = ranking[0].find_all('th')[1].getText()
nombre = ranking[1].find_all('td')[0].getText()
